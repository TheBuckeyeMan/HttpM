...
import am.library.HttpM.WebScrapers.WebScrapeAll;
...
public class HttpMApplication {
	...
	private static void testGetRequest(){
		...
		try {
			WebScrapeAll webScrapeAll = new WebScrapeAll();

			String test = webScrapeAll.webScrapeAllText("https://www.ncaa.com/scoreboard/basketball-men/d1");
			log.info("Value from web scrapeer: " + test);
